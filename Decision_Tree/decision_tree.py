...
print("Memulai proses untuk Model Decision Tree...")
...
#%%
# 2. Preprocessing
# Encode kolom name yang berisi teks kelas target
le = LabelEncoder()
...
print("Visualisasi confusion matrix disimpan sebagai 'confusion_matrix_decision_tree.png'")
...
print("Visualisasi kurva ROC disimpan sebagai 'roc_curve_decision_tree.png'")
